...
import (
	...
	"github.com/forbot161602/pbc-golang-lib/source/core/base/gbmodel"
	"github.com/forbot161602/pbc-golang-lib/source/core/base/gbmtmsg"
)

type (
	MetaMessage = gbmtmsg.MetaMessage

	JSONResponseMeta     = gbmodel.JSONResponseMeta
	JSONResponsePageMeta = gbmodel.JSONResponsePageMeta
	JSONResponseBaseData = gbmodel.JSONResponseBaseData
	JSONResponsePageData = gbmodel.JSONResponsePageData
)
